...
int main()
{
   ...
   //rns.RNSmodmultTest(100);
    ...
    RNS rns_system(rns_moduli);                                                     //getSingleResidues slows significantly for moduli > 15 bits.
    printVector(rns_system.weights,"residue weights: ");
    NTT ntt_system(length, minimum_modulus, rns_system); //it is important to use a prime as the minimum modulus if it is large. It will search for a new prime O.W.
